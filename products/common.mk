...
ifdef CYANOGEN_WITH_GOOGLE
    ...
    PRODUCT_COPY_FILES += $(shell test -d vendor/cyanogen/proprietary/gapps && \
	find vendor/cyanogen/proprietary/gapps -name '*.apk' \
	-printf '%p:system/app/%f ')

    # use all present proprietary lib
    PRODUCT_COPY_FILES += $(shell test -d vendor/cyanogen/proprietary/gapps && \
	find vendor/cyanogen/proprietary/gapps -name '*.so' \
	-printf '%p:system/lib/%f ')

    # use all present proprietary jar
    PRODUCT_COPY_FILES += $(shell test -d vendor/cyanogen/proprietary/gapps && \
	find vendor/cyanogen/proprietary/gapps -name '*.jar' \
	-printf '%p:system/framework/%f ')

    # use all present proprietary xml (permissions)
    PRODUCT_COPY_FILES += $(shell test -d vendor/cyanogen/proprietary/gapps && \
	find vendor/cyanogen/proprietary/gapps -name '*.xml' \
